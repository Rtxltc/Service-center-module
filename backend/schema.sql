...
-- Disable Row Level Security (RLS) since security is managed by the Express backend API
ALTER TABLE repairs DISABLE ROW LEVEL SECURITY;
ALTER TABLE contacts DISABLE ROW LEVEL SECURITY;
ALTER TABLE moto_repairs DISABLE ROW LEVEL SECURITY;
ALTER TABLE laptop_repairs DISABLE ROW LEVEL SECURITY;
